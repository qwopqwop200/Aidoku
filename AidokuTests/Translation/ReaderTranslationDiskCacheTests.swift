...
struct ReaderTranslationDiskCacheTests {
    ...
    @Test(arguments: ["reader-render-v97-observed-texture", "reader-render-v96-one-pixel-fringe", "reader-render-v95-pattern-art-guard", "reader-render-v94-codec-surface", "reader-render-v92-multicolor-fringe", "reader-render-v88-expanded-segmentation", "reader-render-v81-glyph-color-ownership", "reader-render-v68-halo-surface-and-ink", "reader-render-v67-observed-panel-colors", "reader-render-v70-faithful-ink-interior-panel", "reader-render-v66-source-palette-text-box-reflow",
