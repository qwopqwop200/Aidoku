...
void  Module_GenerateNames  (IM3Module i_module)
{
    for (u32 i = 0; i < i_module->numFunctions; ++i)
    {
        ...
        if (func->numNames == 0)
        {
            ...
            if (!buff) continue; // Diagnostic names are optional when memory is exhausted.
